...
litCricFriend(['a','an'],theBells)
litCricFriend(['a','an'],cantoXII)
litCricFriend(['the'],theBells)
litCricFriend(['the'],cantoXII)
...
'''
The frequency of "a" and "an" in Poe is higher than in Neruda's. However,
the frequency of "the" is the same in both.
'''
